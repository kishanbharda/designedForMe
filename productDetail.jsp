				...
				<div class="col-md-12" style="border:2px solid rgb(195,195,195);">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<center><img class="img img-responsive thumbnail" src="images/product/<%= rs.getString(10) %>"/></center>
							<hr>
							<div class="jumbotron">
							
							Category : <%= rs.getString(3) %></br>
							Size : <%= rs.getString(5) %></br>
							Color : <%= rs.getString(6) %></br>
							Price : Rs.<%= rs.getInt(7) %></br>
							Discount : Rs.<%= rs.getInt(8) %></br>
							...
							%>
							<a href="setBuyNow.jsp?id=<%= rs.getInt(1) %>"><button type="button" class="btn btn-info">Buy Now</button></a>
							</div>
						</div>
						<script>

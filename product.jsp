...
<head>
    ...
    <title>product | designedForMe</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12" style="border:2px solid rgb(195,195,195);">
					<h2 style="color:rgb(32,4,213);border-bottom:5px solid rgb(69,12,160);"><%= mainCategory %> <span style="font-size:22px;color:rgb(12,128,32);"> >> <%= subCategory %> </h2>
				
					<div class="row">
						
						<%
							
							ResultSet rs=table.show("Select * from product where MAIN_CATEGORY='"+mainCategory+"' and SUB_CATEGORY='"+subCategory+"' and QUANTITY>0");
							while(rs.next())
							{
								%>
						<div class="col-md-3">

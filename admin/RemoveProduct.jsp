...
<head>
    ...
    <title>DASHBOARD | Remove Product</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Remove Product Here</h1>
                    </div>
                </div>
                <!-- /. ROW  -->
					...
					<div class="col-md-12">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4>Select the product details to remove it.</h4>
							</div>
							<div class="panel-body">
								<form role="form" method="post" action="RemoveProductDB.jsp">
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" name="productId" onKeyPress="return num(event)" placeholder="Enter product ID here to remove it" required>
									</div>
									<input type="hidden" value="RemoveProduct.jsp" name="pageUrl"/>
									<div class="form-group">

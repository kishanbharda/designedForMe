...
<head>
    ...
    <title>DASHBOARD | Remove Category</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Remove Category Here </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
					...
					<div class="col-md-12">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4>Select the appropriate category to remove it.</h4>
							</div>
							<div class="panel-body">
								<form role="form" method="post" action="RemoveCategoryDB.jsp">
									<div class="form-group">
										<label>Select Main Category : </label>
										<select class="form-control" id="mainCat" name="mainCategory">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="subCategory" onKeyPress="return str(event)" required>
									</div>
									<input type="hidden" name="pageUrl" value="RemoveCategory.jsp"/>
									<div class="form-group">

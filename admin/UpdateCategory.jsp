					...
					<div class="col-md-12">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4>Select the appropriate category to update it.</h4>
							</div>
							<div class="panel-body">
								<form role="form" method="post" action="UpdateCategoryDetail.jsp">
									...
									<div class="form-group">
										...
										<input type="text" name="subCategory" class="form-control" onKeyPress="return str(event)" required/>
									</div>
									<input type="hidden" name="pageUrl" value="UpdateCategory.jsp"/>
									<div class="form-group">

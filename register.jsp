...
<head>
    ...
    <title>Register| designedForMe</title>
    ...
    <section id="title" class="emerald">
        <div class="container" style="margin-top:40px;">
            <div class="row">
                <div class="col-sm-6">
                    <h1>Register Here | </h1>
                    <p>To get the best service from us please register first...!</p>
                </div>
                <div class="col-sm-6">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-info col-md-6 col-md-offset-3">
						<form method="post" action="registerToDB.jsp">
							<div class="form-group">
								<label>Enter Mobile</label>
								<input type="text" name="mobile" placeholder="Mobile Number" class="form-control" maxlength="10" onKeyPress="return num(event)" required />
							</div>
							<div class="form-group">
								<label>Create Password</label>
								<input type="password" name="password" placeholder="Password" class="form-control" onKeyPress="return disSpace(event)" required />
							</div>
							<div class="form-group">
								<label>Confirm Password</label>
								<input type="password" name="confirmPassword" placeholder="Confirm Password" onKeyPress="return disSpace(event)" class="form-control" required />
							</div>
							<div class="form-group">

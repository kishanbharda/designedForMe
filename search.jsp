...
<head>
    ...
    <title>Search Result | designedForMe</title>
...
<body>
   ...
   <div id="carousel-example-1" class="carousel slide" data-ride="carousel" style="margin-top:80px;">
	...
	<section id="product">
		<div class="container">
			<div class="row">
				<div class="col-md-12" style="border:2px solid rgb(195,195,195);">
					<h2 style="color:rgb(32,4,213);border-bottom:5px solid rgb(69,12,160);">Seach Result | </h2>
					
					<div class="row">
						
						<%
							
							ResultSet rs=table.show("Select * from product where MAIN_CATEGORY like '"+str+"%' or SUB_CATEGORY like '%"+str+"%' or NAME like '%"+str+"%'");
							while(rs.next())
							{
								%>
						<div class="col-md-3">
                    ...
                    <div>
                        <div class="media">
                            ...
                            <div class="media-body">
                                <br/><span class="media-heading"><a href="www.facebook.com">@designedForMe</a></span>
                            </div>
                        </div>
                        <div class="media">
                            <div class="pull-left">
                            ...
                            <div class="media-body">
                               <br/><span class="media-heading"><a href="www.twitter.com">@designedForMe</a></span>
                            </div>
                        </div>
                        <div class="media">
                            <div class="pull-left">
                            ...
                            <div class="media-body">
                               <br/><span class="media-heading"><a href="www.google-plus.com">@designedForMe</a></span>
						   </div>
                        </div>
                    </div>  
                </div><!--/.col-md-3-->
